...
export const tossToken: BrandToken = {
  ...
  theme: 'light',
  description:
    '빠르고 자신감 있는 금융 인터페이스. 복잡한 금융을 단순하게 만드는 것이 토스의 디자인 철학. 여백을 넉넉하게 사용하고, 핵심 정보를 큰 숫자로 강조하며, 친근한 한국어 어투로 사용자와 대화한다.',
  colors: [
  ...
  spacing: {
    ...
    density: 'comfortable',
    scale: [
      { name: '2', value: '2px', token: '--spacing-2' },
  ...
  shapes: [
    ...
    { element: 'badges', value: '4px' },
    { element: 'bottom sheet', value: '20px 20px 0 0' },
  ],
  layout: {
    maxWidth: '390px (mobile-first)',
    sectionGap: '32px',
  },
  guidelines: {
    dos: [
      ...
      '넉넉한 여백 — 모바일에서 최소 20px 측면 패딩 유지',
      '성공/실패는 색으로 즉시 — 증가는 Green, 감소는 Red 일관 적용',
    ],
    donts: [
      '여러 색상 동시 사용 금지 — 블루 외 강조색을 한 화면에 섞지 않음',
      '작은 터치 영역 금지 — 버튼 최소 높이 48px 유지',
