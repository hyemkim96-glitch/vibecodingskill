...
export const darkTokens: TokenMap = {
  ...
  '--color-fill-success-weak': green[950].hex,
  '--color-fill-danger':       red[400].hex,
  '--color-fill-danger-weak':  red[950].hex,
  '--color-fill-warning':      amber[400].hex,
  '--color-fill-warning-weak': amber[950].hex,
  '--color-fill-info':         blue[400].hex,
  '--color-fill-info-weak':    blue[950].hex,
  '--color-fill-accent':       violet[400].hex,
  '--color-fill-accent-weak':  violet[950].hex,
