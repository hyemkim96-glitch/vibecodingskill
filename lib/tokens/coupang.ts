...
const colors = [
  { name: 'Coupang Red', value: '#C02323', variable: '--color-coupang-red', role: '브랜드 Primary, CTA 버튼, 긴급 세일' },
  { name: 'Rocket Orange', value: '#FF6600', variable: '--color-rocket-orange', role: '로켓배송 뱃지, 빠른 배송 강조' },
