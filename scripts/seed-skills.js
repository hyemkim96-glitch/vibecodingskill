...
const supabaseUrl = 'https://mrkyhltdahtooqsoidld.supabase.co';
const supabaseKey = 'sb_publishable_SjSU0wBaIaUBSuAiiusCFA_oyp7YPWT';
...
async function seed() {
    ...
    for (const skill of defaultSkills) {
        ...
        if (!existing) {
            ...
            if (error) console.error(`Error inserting ${skill.name}:`, error);
            else console.log(`Inserted: ${skill.name}`);
        } else {
